...
ggplot(data = sdata)+geom_bar(mapping = aes(x=num.cups))+labs(x="Number of Cups Per Day",y="Count",title="How Many Coffee's Drunk Per Day")+scale_y_continuous(breaks =c(1,2,3,4,5,6,7,8,9))
